...
namespace KartGame.KartSystems
{
    ...
    public class KartAnimation : MonoBehaviour
    {
        ...
        public string DirectionParam = "ArrowDirection";
        ...
        private int arrowDirectionHash;
        float m_SmoothedSteeringInput;

        private void Awake()
        {
            arrowDirectionHash = Animator.StringToHash(DirectionParam);
        }
        ...
        void FixedUpdate() 
        {
            ...
            KartAnimator.SetFloat(arrowDirectionHash, m_SmoothedSteeringInput);
