...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        [Header("Drifting")]
        [Range(0.0f, 1.0f), Tooltip("The lower the value the easier it is to enter the drift. If the value is 1, there will be no drifting.")]
        ...
        void GatherInputs()
        {
            ...
            for (int i = 0; i < m_Inputs.Length; i++)
            {
                ...
                WantsToDrift = Input.TurnInput > DriftFactor || Input.TurnInput < -DriftFactor;
            }
        }
